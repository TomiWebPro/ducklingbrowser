...
`WAYFERN_TEST_TOKEN`. The runner reads it from the environment or Duckling's ignored `.env` without
...
Set `DUCKLING_E2E_WAYFERN_PATH` to use a local browser fixture. Without it, the runner uses an ignored
