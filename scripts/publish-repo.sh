...
GITHUB_REPO="TomiWebPro/ducklingbrowser"
...
{
  echo "Origin: Duckling Browser"
  echo "Label: Duckling Browser"
  echo "Suite: stable"
...
echo "  echo 'deb [trusted=yes] https://repo.ducklingbrowser.com/deb stable main' | sudo tee /etc/apt/sources.list.d/ducklingbrowser.list"
echo "  sudo apt update && sudo apt install duckling"
echo ""
echo "Users can add the RPM repo with:"
echo "  sudo tee /etc/yum.repos.d/ducklingbrowser.repo << 'EOF'"
echo "  [ducklingbrowser]"
echo "  name=Duckling Browser"
echo "  baseurl=https://repo.ducklingbrowser.com/rpm"
echo "  enabled=1"
echo "  gpgcheck=0"
echo "  EOF"
echo "  sudo dnf install Duckling"
