# Contributing to Duckling Browser (Fork)

Contributions are welcome! This is a community fork of the original Donut Browser with all subscription gating removed — all features are free and unlocked. Please do not create PRs for the sake of being added to the contributors list. Reviewing PRs takes time, so please create PRs only if you believe that your change will improve Duckling for yourself and others. If you are thinking of making a significant change, please get in touch with the maintainer first.
