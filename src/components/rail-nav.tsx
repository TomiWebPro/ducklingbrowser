...
const LOGO_HIDDEN_KEY = "duckling-logo-hidden";
...
function useLogoEasterEgg({
  ...
  const triggerFall = useCallback(() => {
    ...
    cancelFallRef.current = launchDucklingClone(el, {
      onExit: () => {
        try {
  ...
  const handleClick = useCallback(() => {
    ...
    // user back to the profiles list. Growing the duckling requires the user
